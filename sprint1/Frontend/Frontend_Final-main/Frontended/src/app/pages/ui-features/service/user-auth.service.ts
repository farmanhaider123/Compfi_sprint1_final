...
public subject=new Subject();
  ...
  mapApiURL = environment.mapApiURL;
  ...
  toggleStatus(data:any) {
    return this.http.put(`${this.apiURL}updateuserstatus`,data)
  }
  isLogedIn(): boolean  {
  ...
  {
 return this.http.get(`${this.mapApiURL}pincode/${pincode}`);
  }
  ...
  DeleteRole(data: any) {
    return this.http.post(`${this.apiURL}deleteRole`, data)
  }
   DeleteUser(data: any) {
    return this.http.post(`${this.apiURL}DeleteUser`, data)
  }
  GetRoleByid(data: any) {
   return this.http.post(`${this.apiURL}getRolebyid`, data)
  }
toggleModuleStatus(data:any){
    return this.http.post(`${this.apiURL}
toggleModuleStatus`,data)
  }
}
